      ...
      <div style={{ height: items.length * itemHeight, position: 'relative' }}>
        {visibleItems.map((item, index) => (
          ...
          >
            ...
            <p>
                Efficient state management is crucial for performance. Poor
                state management can cause unnecessary re-renders and slow down
                your application.
            </p>
            ...
            <div className="bg-[#1A1A1A] border border-[#333333] rounded-lg p-4 my-6">
                <pre className="text-sm text-gray-300 overflow-x-auto">
                    <code>{`// Split context to avoid unnecessary re-renders
...
const useTheme = () => {
  ...
  return context;
            ...
            <p>
                Images often account for the majority of page weight. Optimizing
                how you load and display images can have a massive impact on
                performance.
            </p>

            <div className="bg-[#1A1A1A] border border-[#333333] rounded-lg p-4 my-6">
                <pre className="text-sm text-gray-300 overflow-x-auto">
                    <code>{`// Lazy loading images with Intersection Observer
...
const ResponsiveImage = ({ image, alt, sizes }) => {
  return (
    <picture>
      <source
